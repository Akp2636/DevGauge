export const calculateCandidateScore = (
    ...
    skills: Array<{ proficiencyScore: number; isVerified: boolean }>,
    projects: Array<{ aiComplexityScore: number }>
) => {
    let score = 0;
    ...
    let rankTag = 'Newbie';
    if (score >= 2400) rankTag = 'Grandmaster';
    else if (score >= 2100) rankTag = 'Master';
    else if (score >= 1900) rankTag = 'Candidate Master';
    else if (score >= 1600) rankTag = 'Expert';
    else if (score >= 1400) rankTag = 'Specialist';
    else if (score >= 1200) rankTag = 'Pupil';
